...
class Space: ObservableObject {
    ...
    init(windows: [Window] = [Window(), Window(), Window(), Window(), Window(), Window(), Window(), Window(), Window(), Window(), Window(), Window(), Window(), Window()], cameraCenterX: CGFloat = 0, cameraCenterY: CGFloat = 0, cameraZoom: CGFloat = 1) {
        self.id = UUID()
